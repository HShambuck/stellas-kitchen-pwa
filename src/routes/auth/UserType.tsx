    ...
    <SafeView variant={isDark ? "dark" : "light"}>
      ...
      >
                ...
                style={{
                  ...
                  backgroundColor: isActive
                    ? isDark
                      ...
                      : card.accentLight
                    : theme.card,
                  border: `${isActive ? 2 : 1}px solid ${isActive ? card.accent : theme.border}`,
                  cursor: "pointer",
                }}
              >
                <div
                ...
                <div style={{ flex: 1 }}>
                  <div
                    style={{
                      ...
                      fontWeight: 800,
                      marginBottom: 2,
                      color: isActive ? card.accent : theme.text,
                    }}
                  >
                    {card.title}
                  </div>
                  <div
                    style={{ fontSize: FONT_SIZES.sm, color: theme.textMuted }}
                  >
                    {card.tagline}
                  </div>
                </div>
                <div
                  style={{
                    ...
                    height: 24,
                    borderRadius: 12,
                    border: `2px solid ${isActive ? card.accent : theme.border}`,
        ...
        <div
          ...
          onClick={() =>
            navigate(selected ? `/auth/login?role=${selected}` : "/auth/login")
          }
        >
