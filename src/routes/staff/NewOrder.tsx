...
export default function NewOrder() {
  ...
  const setCartTier = (index: number, price: string) =>
    setCartItems((prev) =>
      prev.map((item, i) =>
        i === index
          ? { ...item, price, useCustom: false, customPrice: "" }
          : item,
      ),
    );
  ...
  const addCustomItem = () =>
    setCustomItems((prev) => [...prev, { name: "", price: "", quantity: 1 }]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      window.alert(
        `✅ Order Created — Order for ${phoneNumber || "customer"} placed successfully.`,
      );
      resetForm();
    } catch (e: any) {
      ...
      >
                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          border: `1.5px solid ${isSelected ? COLORS.red : theme.border}`,
              ...
              {MENU_PAGES.map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor:
                      i === activePage ? COLORS.red : theme.border,
        ...
        <div style={sectionStyle(theme)}>
          ...
          <input
            ...
            type="tel"
            style={{
              ...inputStyle(theme, focused === "phone"),
              marginBottom: SPACING.lg,
            }}
          ...
          >
            All fields optional for walk-ins. Add a number or location for
            delivery orders.
          </p>
        </div>
        ...
        >
          <span style={{ fontSize: FONT_SIZES.sm, color: theme.textFaint }}>
            Clear form
          </span>
        </button>
...
function CartItemRow({
  ...
  item: CartItem;
  index: number;
  onSetTier: (i: number, v: string) => void;
  onToggleCustom: (i: number) => void;
  onCustomPrice: (i: number, v: string) => void;
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: SPACING.xs }}>
          ...
          <button
            ...
            style={{
              ...
              minWidth: 52,
              textAlign: "center",
              border: `1.5px solid ${item.useCustom ? COLORS.red : theme.border}`,
              backgroundColor: item.useCustom ? COLORS.redDark : theme.inputBg,
              cursor: "pointer",
            }}
          >
            <span
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: SPACING.xs }}>
          <button
            ...
            style={stepBtnStyle(theme.border)}
          >
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: SPACING.sm }}>
        <input
          ...
          style={{
            flex: 2,
            borderRadius: RADIUS.lg,
            border: `1.5px solid ${focused === `cn-${index}` ? COLORS.red : theme.border}`,
            padding: `${SPACING.sm}px ${SPACING.md}px`,
            fontSize: FONT_SIZES.base,
            backgroundColor: theme.inputBg,
            color: theme.text,
        ...
        <input
          ...
          style={{
            flex: 1,
            borderRadius: RADIUS.lg,
            border: `1.5px solid ${focused === `cp2-${index}` ? COLORS.red : theme.border}`,
            padding: `${SPACING.sm}px ${SPACING.md}px`,
            fontSize: FONT_SIZES.base,
            backgroundColor: theme.inputBg,
            color: theme.text,
      ...
      >
        <button
          onClick={() =>
            onUpdate(index, "quantity", Math.max(1, item.quantity - 1))
          }
          style={stepBtnStyle(theme.border)}
        >
          <span style={{ ...stepTxtStyle, color: theme.text }}>−</span>
...
const stepTxtStyle: CSSProperties = {
